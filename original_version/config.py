...
class Config:
    ...
    # LLM Generation Settings - Use fallback model for better performance
    DEFAULT_LLM_MODEL = "microsoft/DialoGPT-small"  # Fast, reliable model
    FALLBACK_LLM_MODEL = "gpt2"
    GRANITE_LLM_MODEL = "ibm-granite/granite-3.0-2b-instruct"  # Available for advanced users
    ...
    GOOGLE_API_KEY = "AIzaSyA9JEBW5u-xaOJz2gApcpwIwylZZkD09XI"  # Gemini API key as fallback
